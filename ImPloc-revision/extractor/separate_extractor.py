...
CIMG_DIR = c.QDATA_DIR  # input dir
CFV_DIR = c.NORMAL_FV_DIR  # output dir
PROJECT_DIR = c.PROJECT  # root dir
...
def get_gene_list():
    genes = []
    genelist = os.path.join(PROJECT_DIR, "spider/genelist", "enhanced1.list")
...
def extract():
    q = queue.Queue()
    for gene in get_gene_list():  # gene is a folder
